...
export const translations = {
  ru: {
    ...
    header: {
      ...
      apply:        'Подать заявку',
      announcement: 'Только: финансирование, соответствующее ценностям',
    },
    hero: {
      title:    'Для роста и развития — надёжная инвестиция',
    ...
    stats: [
      ...
      { value: '4',      label: 'продукта'  },
      { value: '2 часа', label: 'Одобрение' },
      { value: 'С 2025', label: 'года'      },
    ],
    halal: {
      sectionLabel: 'Исламские финансы',
      title:        'Финансирование, основанное на ценностях',
      badge:        '',
      bankCol:      'Традиционный банк',
      belvestCol:   'Belvest',
      row1:         'Без процентов',
      row2:         'Фиксированная наценка (Мурабаха)',
      row3:         'Полная прозрачность условий',
      row4:         'Соответствие ценностям',
  ...
  uz: {
    ...
    header: {
      ...
      apply:        'Ariza berish',
      announcement: 'Faqat: qadriyatlarga mos moliyalashtirish',
    },
    hero: {
      title:    "O'sish va rivojlanish uchun ishonchli investitsiya",
      subtitle: 'Lizing, nasiya savdo, treyd-in va investitsiyalar',
    },
    buttons: {
      learnMore: 'Batafsil',
      calculate: 'Hisoblash',
    ...
    services: {
      ...
      installment: 'Nasiya savdo (Murabaha)',
      tradein:     'Treyd-in',
    ...
    stats: [
      { value: '1000+',  label: 'mijoz'       },
      { value: '4',      label: 'mahsulot'    },
      { value: '2 soat', label: 'tasdiqlash'  },
      { value: '2025',   label: 'yildan beri' },
    ],
    halal: {
      sectionLabel: 'Islom moliyasi',
      title:        'Qadriyatlarga asoslangan moliyalashtirish',
      badge:        '',
      bankCol:      "An'anaviy bank",
      belvestCol:   'Belvest',
      row1:         'Foizsiz',
      row2:         'Belgilangan ustama (Murabaha)',
      row3:         "To'liq shaffoflik",
      row4:         'Qadriyat talablariga muvofiqlik',
      row5:         'Foyda taqsimoti (Mudaraba)',
    },
    catalog: {
      breadcrumbHome:   'Bosh sahifa',
      title:            'Tovarlar katalogi',
      subtitle:         'Barcha tovarlar nasiya savdo va lizingda mavjud',
      ...
      applyInstallment: 'Nasiya savdo rasmiylashtirish',
    ...
    about: {
      ...
      missionBody:      "Biz sifatli moliyaviy vositalar — lizing, nasiya savdo, treyd-in va investitsiyalar — O'zbekistonning har bir fuqarosi va biznesi uchun ochiq bo'lishi kerak deb ishoniladi.",
  ...
  header:     { cabinet: string; apply: string; announcement: string };
