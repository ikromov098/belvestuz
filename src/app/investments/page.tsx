...
const FAQS = [
  ...
  {
    q: 'Застрахованы ли мои инвестиции?',
    a: 'Belvest работает в соответствии с законодательством Республики Узбекистан. Средства клиентов используются исключительно для финансирования лизинговых и рассрочных сделок, обеспеченных реальным имуществом. Подробнее об условиях — у вашего менеджера. Каждая инвестиция официально оформлена и задокументирована.',
  },
  {
  ...
  },
  {
    ...
    a: 'Да, досрочный вывод возможен не ранее чем через 2 месяца с начала срока размещения и требует предварительного уведомления. При досрочном выводе прибыль пересчитывается по условиям базового тарифа за фактический период размещения средств. Минимальный срок инвестиции — 12 месяцев.',
  },
];

const STATS = [
  { value: 'до 20%', label: 'Прогн. прибыль (Мудараба)' },
