...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Да, досрочный вывод возможен после минимального срока хранения (2–6 месяцев в зависимости от плана). При досрочном выводе прибыль пересчитывается по условиям базового тарифа за фактический срок.',
  },
];
