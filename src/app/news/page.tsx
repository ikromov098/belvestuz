...
type Category = 'Все' | 'Новости компании' | 'Исламские финансы' | 'Гиды и советы';
...
const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: 'Мурабаха — одна из наиболее распространённых структур исламского финансирования. В отличие от традиционного кредита, при Мурабаха финансовая компания сначала сама покупает товар, а затем продаёт его клиенту по заранее оговорённой цене с фиксированной наценкой.\n\nГлавное отличие от банковского кредита — отсутствие Риба (процентов). Наценка известна с самого начала и не может увеличиться в процессе выплат. Это делает финансирование прозрачным и предсказуемым.\n\nШариатский совет Belvest одобрил все продукты Мурабаха, гарантируя их соответствие нормам ислама. Клиент всегда знает полную стоимость товара до подписания договора.\n\nПо принципу Мурабаха в Belvest работают: рассрочка на электронику, бытовую технику, мебель и смартфоны. Срок — от 3 до 24 месяцев. Ставка наценки фиксирована на весь период.\n\nЕсли у вас остались вопросы, обратитесь к нашим специалистам по телефону +998 77 480-99-99 или в Telegram @belvest_info.',
  },
  {
    id: 3,
